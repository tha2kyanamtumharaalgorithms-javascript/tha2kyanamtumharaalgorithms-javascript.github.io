...
async function gosh(obj1, obj2, obj3) {
  ...
  await Promise.all([
    ...
    new Promise(rez => {
      let list = "";
      dlurl = 'https://anlof6ho4kmtewslnyk34ip2f40pedjp.lambda-url.ap-south-1.on.aws';//.join('');
...
async function dlfn(v, id) {
  ...
  if (((ptd.add == '') || (ptd.mn1 == '')) && (intt != 'Save')) {
    ...
    if (id == 'shp') {
      ...
      dlurl = "https://anlof6ho4kmtewslnyk34ip2f40pedjp.lambda-url.ap-south-1.on.aws/del/" + id;
